    ...
    <div class="wrapper">
        ...
        <section class="container">
            ...
            <div class="container-inner">
                ...
                <?php
                     if($_SESSION['role'] == 'parent') {
                         $info = "SELECT name, gender, email, phone, username from parents WHERE username= '".$_SESSION['username']."'";
                        ...
                        echo '<div class="tabs">
                         ...
                         <div class="tabs">
                            ...
                            <div class="tabs-container">';
                                ...
                                $spec_child = "SELECT name from students WHERE parentid= '".$_SESSION['username']."'";
                                $result_spec_child = mysqli_query($con, $spec_child) or die(mysqli_error($con));
                                while($spec_child_list =  mysqli_fetch_assoc($result_spec_child)) {
                                    echo '<div class="tabs-info">
                                        '.$spec_child_list['name'].'
                                    </div>';
                                }
                            echo '</div>
                        </div>';
                     } else if($_SESSION['role'] == 'teacher') { /* teacher */
                         $info = "SELECT name, gender, email, phone, username, officehours from teachers WHERE username= '".$_SESSION['username']."'";
                         $result_info = mysqli_query($con, $info) or die(mysqli_error($con));
                         $display = mysqli_fetch_assoc($result_info); 
                        ...
                        echo '<div class="tabs">
                         ...
                         <div class="tabs">
                          ...
                          $info = "SELECT name, gender, email, phone, username, intake, grade from students WHERE username= '".$_SESSION['username']."'";
                         $result_info = mysqli_query($con, $info) or die(mysqli_error($con));
                         $display = mysqli_fetch_assoc($result_info); 
