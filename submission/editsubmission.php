<?php
    ...
    $query_string = "UPDATE {$courseid} SET filename = ?, filedesc = ?, visibility = ?, uploadtime = ?, filedir = ? WHERE fileid = ?";
    $query_update = $con->prepare($query_string);
    $query_update->bind_param("ssssss", $filetitle, $filedesc, $visible, $updatetime, $filedir, $currfile);
